---
title: "liver_GO_analysis.panther_slim"
...
```{r}
# マーカー検出結果の取得
read_tsv("Liver/Hs_Mm_liver.seurat_integrate.celltype_pick.Hs_markergene.tsv",
         show_col_types = FALSE) -> Hs_all.marker
read_tsv("Liver/Hs_Mm_liver.seurat_integrate.celltype_pick.Hs_only.markergene.tsv",
         show_col_types = FALSE) -> Hs_only.marker
read_tsv("Liver/Hs_Mm_liver.seurat_integrate.celltype_pick.Hs_ortholog.markergene.tsv",
...
createGOanalysis_outfile <- function(sp, ident, testtype = "FISHER", target)
  paste("Liver/PANTHER/", sp, "/", sp, "_PANTHER_ident_",
        cluster.id, "_", testtype, "_BPslim_", target, "_gene.tsv", sep="")
```
...
read_data <- function(sp, cluster, type = "all"){
  read_tsv(paste("Liver/PANTHER/", sp, "/", sp, "_PANTHER_ident_",
                 cluster, "_FISHER_BPslim_", type, "_gene.tsv", sep = ""),
...
for(ident in Mm_cluster_list){
  ...
  outfile <- paste("Liver/PANTHER/Comparison/GO_slim/compare_ident_",
               ident, "_human-mouse.GOslim.png", sep= "")
...
for(ident in 0:14){
  ...
  outfile <- paste("Liver/PANTHER/Comparison/GO_slim/Hs_compare_ident_",
                   ident, "_SS-ortholog.GOslim.png", sep= "")
...
for(ident in Mm_cluster_list){
  ...
  outfile <- paste("Liver/PANTHER/Comparison/GO_slim/Mm_compare_ident_",
                 ident, "_SS-ortholog.GOslim.png", sep= "")
